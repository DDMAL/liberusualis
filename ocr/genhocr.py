...
"""
Put this in the dir with original .tiff/.jpg images. Generates hocrs from all the .tiff/.jpgs in the pwd and copies them to a new dir hocr_output.
"""

# Binarize images
os.system('ocropus-binarize *.jpg') #original file type was .tiff, updated to .jpg in 2026 recovery using the images from arbutus object storage
