    ...
    $('document').ready(function() {
        ...
        $('#diva-wrapper').diva({
            ...
            onReady: function() {
                ...
                test("inViewport()", function() {
                    ok(dv.inViewport(1, 10, 40));
                    ok(!dv.inViewport(1, 800, 1000));
                    ok(!dv.inViewport(4, 10, 1000));
                });
                ...
                test("updateHashParam()", function() {
                    ...
                    // Now set the hash to nothing
                    window.location.hash = '';
                });

                test("removeHashParam()", function() {
                    window.location.hash = '#test=test';

                    $.removeHashParam('test');
                    equals(window.location.hash, '');

                    window.location.hash = '#test=test&lol=lol';
                    $.removeHashParam('lol');
                    equals(window.location.hash, '#test=test');
                    $.removeHashParam('notthere');
                    equals(window.location.hash, '#test=test');
                });
            }
        });
